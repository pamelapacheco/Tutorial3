...
@protocol NotasSeccionCustomCellDelegate;

@interface NotasSeccionCustomCell : UITableViewCell{
...
//Delegados
@property (strong, nonatomic) id <NotasSeccionCustomCellDelegate> delegateTouchImagen;
...
@protocol NotasSeccionCustomCellDelegate <NSObject>
